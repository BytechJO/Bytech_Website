...
const fallbackHero = {
  ...
  description:
    "Six integrated service lines — software, mobile, education, content, media, and growth — working together inside one professional delivery model.",
};
      ...
      <div className="absolute bottom-[110px] left-0 right-0 z-[2] px-6 lg:px-[60px]">
        <div className="max-w-[720px]">
          ...
          <EditableText
            ...
            onChangePath={onChangePath}
            className="services-reveal services-delay-2 max-w-[600px] text-[15px] leading-[1.78] text-white/50 sm:text-base"
          />
        </div>
      </div>
    </section>
