  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-[#0e1c2e]">
        <div className="pointer-events-none absolute -right-[100px] -top-[150px] z-[1] h-[500px] w-[500px] rounded-full bg-[#F57A24]/[0.09] blur-[100px] [animation:eduOrb1_10s_ease-in-out_infinite]" />
        ...
        <div className="relative z-[2] px-6 pb-20 pt-[140px] lg:px-[60px]">
          <div className="max-w-[720px]">
            <div className="edu-hero-reveal mb-6 inline-flex items-center gap-2 rounded-full border border-[#F57A24]/20 bg-[#F57A24]/[0.08] px-3.5 py-1.5">
              <span className="h-1.5 w-1.5 rounded-full bg-[#F57A24] [animation:eduPulse_2s_infinite]" />
              <span className="text-[10px] font-bold uppercase tracking-[1.5px] text-[#F57A24]">
                EdTech
              </span>
            </div>

            <h1 className="edu-hero-reveal edu-delay-1 mb-[18px] text-[42px] font-black leading-[1.05] tracking-[-2px] text-white sm:text-[56px]">
              A strong{" "}
            ...
            <p className="edu-hero-reveal edu-delay-2 max-w-[600px] text-base leading-[1.78] text-white/50">
