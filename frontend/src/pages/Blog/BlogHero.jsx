...
const fallbackHero = {
  image:
    "https://images.unsplash.com/photo-1432821596592-e2c18b78144f?w=1400&auto=format&fit=crop",
  imageAlt: "Blog",
  badge: "Insights",
  titleBefore: "Insights &",
  titleHighlight: "ideas.",
  description:
    "Thoughts on digital transformation, EdTech, software development, and building scalable digital products — from the Bytech team.",
};
...
export default function BlogHero({
  ...
  const revealClass = editable ? "" : "blog-reveal";
        ...
        <div className="max-w-[720px]">
          ...
          <h1
            className={`${revealClass} ${delayClass(
              "blog-delay-1",
            )} mb-5 text-[42px] font-black leading-[1.05] tracking-[-2px] text-white sm:text-[56px] lg:text-[58px]`}
          >
            <EditableText
              as="span"
