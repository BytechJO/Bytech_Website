    ...
    <section className="relative overflow-hidden bg-[#0e1c2e]">
      ...
      <div className="absolute bottom-[70px] left-0 right-0 z-[2] px-6 lg:px-[60px]">
        <div className="max-w-[720px]">
          <div className="contact-reveal mb-6 inline-flex items-center gap-2 rounded-[20px] border border-[#F57A24]/20 bg-[#F57A24]/[0.08] px-[14px] py-[6px]">
          ...
          <h1 className="contact-reveal contact-delay-1 mb-5 max-w-[760px] text-[42px] font-black leading-[1.05] tracking-[-2px] text-white sm:text-[56px] lg:text-[58px]">
          ...
          <p className="contact-reveal contact-delay-2 max-w-[600px] text-[15px] leading-[1.78] text-white/50 sm:text-base">
            Ready to start your project? Reach out and we&apos;ll get back to
            you within 24 hours with a tailored response to your needs.
          </p>
        </div>
      </div>
    </section>
