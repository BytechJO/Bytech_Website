    ...
    <section className="relative overflow-hidden bg-[#0e1c2e]">
      ...
      <div className="absolute bottom-[20px] left-0 right-0 z-[2] px-6 lg:px-[60px]">
        <div className="max-w-[720px]">
          <div className="portfolio-reveal mb-6 inline-flex items-center gap-2 rounded-[20px] border border-[#F57A24]/20 bg-[#F57A24]/[0.08] px-[14px] py-[6px]">
          ...
          <h1 className="portfolio-reveal portfolio-delay-1 mb-5 max-w-[680px] text-[42px] font-black leading-[1.05] tracking-[-2px] text-white sm:text-[56px] lg:text-[58px]">
            Brands that trust{" "}
