...
const fallbackHero = {
  ...
  imageAlt: "Portfolio",
  badge: "Selected Work",
  titleBefore: "Brands that trust",
  titleHighlight: "Bytech.",
  description:
    "Organizations that value structured execution, modern digital solutions, and long-term technical partnership — across education, business, publishing, and e-commerce.",
};
    ...
    <section className="relative overflow-hidden bg-[#0e1c2e]">
      ...
      <div className="absolute bottom-[20px] left-0 right-0 z-[2] px-6 lg:px-[60px]">
        <div className="max-w-[720px]">
          ...
          >
            <span className="h-[6px] w-[6px] rounded-full bg-[#F57A24] shadow-[0_0_0_6px_rgba(245,122,36,0.08)] [animation:portfolioPulse_2s_infinite]" />
          ...
          <h1
            className={`${revealClass} ${delayClass(
              "portfolio-delay-1",
            )} mb-5 max-w-[680px] text-[42px] font-black leading-[1.05] tracking-[-2px] text-white sm:text-[56px] lg:text-[58px]`}
          >
            <EditableText
              as="span"
